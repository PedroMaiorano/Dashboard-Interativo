...
d2020 <- read.csv("C:\\Users\\zabuz\\OneDrive\\Área de Trabalho\\Datran Metodologia\\datatran2020.csv", TRUE, ';')

d2019 <- read.csv("C:\\Users\\zabuz\\OneDrive\\Área de Trabalho\\Datran Metodologia\\datatran2019.csv", TRUE,';')

d2018 <- read.csv("C:\\Users\\zabuz\\OneDrive\\Área de Trabalho\\Datran Metodologia\\datatran2018.csv", TRUE, ';')
                     ...
                     dashboardBody(
                         tabItems(
                             ...
                             tabItem(
                                 ...
                                 fluidRow(
                                     box(paste("Nome: Pedro Henrique Freitas Maiorano - pedro.maiorano@usp.br"))),
                                 fluidRow(
                                     box(paste('Nome: Wemerson Mauricio dos Santos - wemersonmauricio@usp.br'))
